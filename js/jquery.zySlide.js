...
(function ($) {
    ...
    function Slide(ele, options) {
        ...
        this.states = [
            { '&zIndex': 2, width: 250, height: 166, top: 160, left: 0, $opacity: 0.6 },
            { '&zIndex': 3, width: 500, height: 333, top: 80, left: 80, $opacity: 0.7 },
            { '&zIndex': 4, width: 750, height: 500, top: 0, left: 220, $opacity: 1 },
            { '&zIndex': 3, width: 500, height: 333, top: 80, left: 600, $opacity: 0.7 },
            { '&zIndex': 2, width: 250, height: 166, top: 160, left: 930, $opacity: 0.6 },
        ]
